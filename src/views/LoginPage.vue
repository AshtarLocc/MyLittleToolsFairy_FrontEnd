    ...
    <div class="login">
        <div class="relative">
                ...
                <el-row>
                    <el-col :span="24">
                        <div class="homepageLogo">
                            <ul>
                                <li>
                                    <el-image style="width: 50px;height: 50pxpx;" :src="url" fit="fill" />
                                </li>
                                <li>
                                    <span>耶嘿</span>
                                </li>
            ...
            <div class="right">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-form :model="form" label-width="120px" lable-position="top" size="large" class="form" :rules="rules" ref="ruleFormRef"> 
                            <el-form-item label="用戶名" prop="userName">
                                <el-input v-model="form.userName"/>
                            </el-form-item>
                            <el-form-item label="密碼" prop="passWord">
                                <el-input v-model.number="form.passWord" type="password" show-password @keyup.enter="OnSubmit(ruleFormRef)"/>
                            </el-form-item>
                            <el-form-item>
                                <el-button class="submitBtn" type="primary" @Click="OnSubmit(ruleFormRef)">登入</el-button>
                            </el-form-item>
                        </el-form>
                    </el-col>
                </el-row>
...
const rules = reactive<FormRules>({
    ...
    passWord: [{required:true,message:'請輸入密碼',trigger:'blur',type:"number"}]
});
